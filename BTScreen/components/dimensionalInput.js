const dirComponentWidth = toInt(config.componentWidth / 3);
...
module.exports = (command, text = command) => {
  ...
  return {
    ...
    height: config.componentHeight * 3,
    render: function (screen, xOffset, yOffset) {
      //left
      screen.addText(
        text,
        xOffset + 3,
        yOffset + config.componentHeight / 2 - 5,
        0xffffff,
        true
      );
      screen.addButton(
      ...
      screen
        .addTextInput(
          ...
          yOffset + config.componentHeight - 1,
          dirComponentWidth + 2,
          config.componentHeight + 2,
          "1",
      ...
      screen.addButton(
        xOffset + dirComponentWidth,
        yOffset + config.componentHeight * 2,
        dirComponentWidth,
        config.componentHeight,
        1,
        "south",
